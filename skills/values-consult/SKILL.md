...
Use this skill when you're about to make a choice on Oliver's behalf that
depends on his values, not just on facts. Examples:
...
- Making a recommendation when there are real tradeoffs between things
  Oliver cares about.
- Voting, signing, or committing to anything on his behalf.
...
4. **Decide between three actions:**
   ...
   b. **Cards conflict → ask Oliver.** If two or more cards apply and
      pull in different directions, do NOT silently paper over the
      tension. Surface the conflict to Oliver: "I see your card on X and
   ...
   c. **No card clearly applies → ask Oliver, and offer to elicit.**
...
5. **Bias toward asking.** Oliver would rather be interrupted than
   misrepresented. When in doubt, ask.

## What NOT to do

- Do not guess at Oliver's values from base-model priors. If VALUES.md
...
- Do not treat attention policies as preferences. They are discernment
  ...
  what Oliver "prefers" in the abstract.
- Do not flatten context-bound values into context-free principles.
  Oliver's value about honesty in technical work is not the same as his
